...
test(puzzle_solution([[0,120,1080,12,84],[180,_,_,5,_],[13,_,_,_,_],[336,_,_,_,_],[120,_,_,_,_]]),[puzzle_solution([[0,120,1080,12,84],[180,4,9,5,1],[13,5,4,1,3],[336,2,6,4,7],[120,3,5,2,4]])],40,1).
test(puzzle_solution([[0,1680,36,27,60],[17,_,_,_,_],[28,_,_,9,_],[180,_,_,_,_],[168,_,_,_,_]]),[puzzle_solution([[0,1680,36,27,60],[17,6,2,8,1],[28,8,6,9,5],[180,5,3,6,2],[168,7,1,4,6]])],40,1).
